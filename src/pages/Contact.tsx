...
const socialLinks = [
  {
    name: "Instagram",
    handle: "@inspireindiatalks",
    icon: <Instagram className="h-5 w-5" />,
    url: "https://www.instagram.com/inspireindiatalks/",
    color: "hover:bg-pink-500/10 hover:border-pink-500/40 hover:text-pink-400",
  },
  {
    name: "Facebook",
    handle: "Inspire India Talks",
    icon: <Facebook className="h-5 w-5" />,
    url: "https://www.facebook.com/p/Inspire-India-Talks-61577643296599/",
  ...
  },
  {
    ...
    url: "https://www.linkedin.com/company/inspire-india-talks/",
  ...
  },
  {
    ...
    url: "https://www.youtube.com/channel/UCrvZvbuRbBc7TEBLH3T5NQQ",
...
const Contact = () => {
  ...
  const fields = [
    { name: "name", label: "Full Name", type: "text", required: true, placeholder: "Your full name", icon: <User className="h-4 w-4" /> },
    { name: "email", label: "Email Address", type: "email", required: true, placeholder: "you@example.com", icon: <Mail className="h-4 w-4" /> },
    { name: "subject", label: "Subject", type: "text", required: true, placeholder: "What's this about?", icon: <MessageSquare className="h-4 w-4" /> },
  ];
            ...
            <div className="glass-card p-8">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:hello@inspireindiatalks.com"
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="glass-card p-6 rounded-2xl space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full rounded-xl py-6 text-base font-medium hover:shadow-lg hover:shadow-primary/20 transition-all"
